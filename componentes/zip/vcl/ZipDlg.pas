...
uses SysUtils, Graphics, ExtCtrls, ZipMsg, ZipStrs;
...
var
  ...
  X, Y, ALeft, CWidth, CHeight: Integer;
...
begin
  ...
  CWidth := Max(IconTextWidth, ButtonGroupWidth);
  ...
  begin
    ...
    begin
      ...
      SetBounds(ALeft, IconTextHeight + VMargin + VSpacing,
        Max(PWLEN * AvDlgUnits.X, TextRect.Right), 15);
    end;
